export const EN_US_MESSAGES = {
    ...
    "settings.display_app_name": "Display app name",
    "settings.display_app_name_hint": "Shown in the sidebar, login screen, and document title. Leave empty to use the default.",
    "settings.app_icon": "App icon",
    "settings.app_icon_hint": "PNG, JPEG, WebP, or SVG. Used in the shell, favicon, and PWA manifest when possible.",
    "settings.upload_app_icon": "Upload",
    "settings.reset_app_icon": "Reset",
    "settings.app_icon_unsupported": "Choose a PNG, JPEG, WebP, or SVG image",
    "settings.app_icon_too_large": "The image is too large. Try a smaller file.",
    "settings.app_icon_unsafe_svg": "This SVG contains unsupported content. Try another file.",
    "settings.app_icon_decode_failed": "This image could not be read. Try another file",
    "settings.app_icon_encode_failed": "The image could not be prepared. Try another file",
