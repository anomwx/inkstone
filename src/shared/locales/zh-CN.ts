...
export const ZH_CN_MESSAGES = {
    ...
    "session.logout_local_warning": "服务器退出失败（{detail}）。本机已退出登录 — 若其他设备仍保持登录，请清除该站点 Cookie。",
    ...
    "settings.branding": "品牌标识",
    "settings.display_app_name": "显示应用名称",
    "settings.display_app_name_hint": "显示在侧边栏、登录页和浏览器标题。留空则使用默认名称。",
    "settings.app_icon": "应用图标",
    "settings.app_icon_hint": "支持 PNG、JPEG、WebP 或 SVG。会尽量用于界面、网站图标和 PWA 清单。",
    "settings.upload_app_icon": "上传",
    "settings.reset_app_icon": "重置",
    "settings.app_icon_unsupported": "请选择 PNG、JPEG、WebP 或 SVG 图片",
    "settings.app_icon_too_large": "图片过大，请换一张更小的",
    "settings.app_icon_unsafe_svg": "该 SVG 包含不支持的内容，请换一张",
    "settings.app_icon_decode_failed": "无法读取该图片，请换一张试试",
    "settings.app_icon_encode_failed": "无法处理该图片，请换一张试试",
